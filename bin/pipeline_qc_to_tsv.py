...
#######################################################################
#######################################################################
## Created on August 29th 2018 to create QC metrics file
#######################################################################
#######################################################################
...
Description = 'Create a tab-delimited file with various QC metrics generated by BABS-MNASeqPE pipeline. This will be specific to directory structure of BABS-MNASeqPE nextflow pipeline.'
Epilog = """Example usage: python pipeline_qc_to_tsv.py <RESULTS_DIR> <OUT_FILE>"""
...
def pipeline_qc_to_tsv(ResultsDir,OutFile):
    ...
    sectionOrder = ['RUN-LEVEL', 'REPLICATE-LEVEL']
    fout = open(OutFile,'w')
...
pipeline_qc_to_tsv(ResultsDir=args.RESULTS_DIR,OutFile=args.OUT_FILE)
